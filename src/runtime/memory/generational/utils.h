...
#define INCREMENT_GENERATION(object) \
    do {                                 \
        ...
        lox_value_t forwading_ptr = GET_FORWARDING_PTR(object);                         \
...
#define SET_FORWARDING_PTR(object_ptr, new_ptr) (object_ptr)->gc_info = (void *) (((uint64_t) (new_ptr)) | ((uint64_t) object_ptr->gc_info & 0xE000000000000000))
