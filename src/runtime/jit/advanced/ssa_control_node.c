...
void for_each_data_node_in_control_node(struct ssa_control_node * control_node, void * extra, ssa_data_node_in_control_consumer_t consumer) {
    switch(control_node->type){
        ...
        case SSA_CONTORL_NODE_TYPE_SET_GLOBAL: {
            ...
            consumer(control_node, set_global->value_node, extra);
            break;
        }
        case SSA_CONTROL_NODE_TYPE_SET_STRUCT_FIELD: {
            ...
            consumer(control_node, set_struct_field->new_field_value, extra);
            consumer(control_node, set_struct_field->instance, extra);
            break;
        }
        case SSA_CONTROL_NODE_TYPE_SET_ARRAY_ELEMENT: {
            ...
            consumer(control_node, set_array_element->new_element_value, extra);
            consumer(control_node, set_array_element->array, extra);
            break;
        }
        case SSA_CONTROL_NODE_TYPE_CONDITIONAL_JUMP:
            ...
            consumer(control_node, conditional_jump->condition, extra);
            break;
