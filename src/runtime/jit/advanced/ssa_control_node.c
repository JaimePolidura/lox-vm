...
void * allocate_ssa_block_node(ssa_control_node_type type, size_t struct_size_bytes, struct ssa_block * block) {
    struct ssa_control_node * ssa_control_node = NATIVE_LOX_MALLOC(struct_size_bytes);
