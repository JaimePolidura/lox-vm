...
bool for_each_ssa_data_node(struct ssa_data_node *, void **, void *, long options, ssa_data_node_consumer_t);
...
bool is_marked_as_escaped_ssa_node(struct ssa_data_node *data_node);
